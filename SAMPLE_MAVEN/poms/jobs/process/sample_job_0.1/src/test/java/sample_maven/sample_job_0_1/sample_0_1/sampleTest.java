...
package sample_maven.sample_job_0_1.sample_0_1;
 ...
 * @status
 */
public class sampleTest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "sampleTest.log");
	}
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(sampleTest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tCreateTemporaryFile_1_error(Exception exception, String errorComponent,
	...
	public void tFileCompare_1_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tCreateTemporaryFile_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCompare_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tAssert_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = sampleTest.class.getClassLoader()
					.getResourceAsStream("sample_maven/sample_job_0_1/sample_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = sampleTest.class.getClassLoader()
	...
	public void tCreateTemporaryFile_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tCreateTemporaryFile_1", "tCreateTemporaryFile_1", "tCreateTemporaryFile");
				...
				file_tCreateTemporaryFile_1 = java.io.File.createTempFile(name_tCreateTemporaryFile_1,
						suffix_tCreateTemporaryFile_1, dir_tCreateTemporaryFile_1);
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tCreateTemporaryFile_1:OnSubjobOk", "",
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_SAMPLE_MAVEN_sample = new byte[0];
		static byte[] commonByteArray_SAMPLE_MAVEN_sample = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_SAMPLE_MAVEN_sample) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						((String) globalMap.get("tCreateTemporaryFile_1_FILEPATH")))).getAbsolutePath().replace("\\",
								"/");
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = "
									+ "\"C:/Users/Solvento/Downloads/5000-Records/5000 Records.csv\"");
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/Solvento/Downloads/5000-Records/5000 Records.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Solvento/Downloads/5000-Records/5000 Records.csv", "ISO-8859-15", ",", "\n",
...
// Start of branch "row2"
						if (row2 != null) {
							...
							if (enableLogStash) {
								if (runStat.updateLog(iterateId, 1, 1
										...
										, "row2", "tFileInputDelimited_1", "tFileInputDelimited_1",
										"tFileInputDelimited", "tFileOutputDelimited_1", "tFileOutputDelimited_1",
					...
					if (!((Object) ("C:/Users/Solvento/Downloads/5000-Records/5000 Records.csv") instanceof java.io.InputStream)) {
				...
				if (enableLogStash) {
					...
					if (runStat.log(resourceMap, iterateId, "row2", 2, 0, "tFileInputDelimited_1",
							"tFileInputDelimited_1", "tFileInputDelimited", "tFileOutputDelimited_1",
	...
	public void tFileCompare_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileCompare_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileCompare_1.append(
									"FILE" + " = " + "((String)globalMap.get(\"tCreateTemporaryFile_1_FILEPATH\"))");
							log4jParamters_tFileCompare_1.append(" | ");
							log4jParamters_tFileCompare_1.append("FILE_REF" + " = " + "context.reference_file1");
							log4jParamters_tFileCompare_1.append(" | ");
							log4jParamters_tFileCompare_1
									.append("DIFFER_MESSAGE" + " = " + "\"[job \" + jobName + \"] Files differ\"");
							log4jParamters_tFileCompare_1.append(" | ");
							log4jParamters_tFileCompare_1.append(
									"NO_DIFFER_MESSAGE" + " = " + "\"[job \" + jobName + \"] Files are identical\"");
							log4jParamters_tFileCompare_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileCompare_1", "tFileCompare_1", "tFileCompare");
					talendJobLogProcess(globalMap);
				}
				...
				if (result_tFileCompare_1) {
					...
					java.io.BufferedReader fileRef_tFileCompare_1 = new java.io.BufferedReader(
							new java.io.InputStreamReader(new java.io.FileInputStream(context.reference_file1),
									"ISO-8859-15"));
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileCompare_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tAssert_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tAssert_1", "tAssert_1", "tAssert");
					talendJobLogProcess(globalMap);
				}
				...
				if (!((Boolean) globalMap.get("tFileCompare_1_DIFFERENCE"))) {
					...
					junitGlobalMap.put("tests.log",
							((String) junitGlobalMap.get("tests.log")) + "tAssert_1:"
	...
	public static void main(String[] args) {
		final sampleTest sampleTestClass = new sampleTest();

		int exitCode = sampleTestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'sample' - Done.");
		}
	...
	public void testDefault() throws java.lang.Exception {
		...
		sampleTestClass.runJobInTOS(arrays);
		...
		if (sampleTestClass.exception != null) {
			throw sampleTestClass.exception;
		}
	}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'sample' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = sampleTest.class.getClassLoader().getResourceAsStream(
					"sample_maven/sample_job_0_1/sample_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = sampleTest.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					if (context.getStringValue("reference_file1") == null) {
						context.reference_file1 = null;
					} else {
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sampleTest");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 81401 characters generated by Talend Data Fabric on the September 29, 2021
 * 2:45:10 PM SGT
 ************************************************************************************************/